...
def test_advanced_preview(client):
    ...
    response = client.post('/api/advanced/preview',
                          data=json.dumps(params),
                          content_type='application/json')
...
def test_batch_generation(client):
    ...
    response = client.post('/api/batch_generate',
                          data=json.dumps(params),
                          content_type='application/json')
...
def test_calibration_endpoints(client):
    ...
    response = client.post('/api/calibration/charuco',
    ...
    response = client.post('/api/calibration/aruco_board',
    ...
    response = client.post('/api/calibration/apriltag',
...
def test_validation_endpoints(client):
    ...
    response = client.post('/api/validation/hamming_distance',
    ...
    response = client.post('/api/validation/test_pattern',
