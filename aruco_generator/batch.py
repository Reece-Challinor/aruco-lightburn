...
class BatchGenerator:
    ...
    def generate_batch_files(
        ...
        with zipfile.ZipFile(zip_buffer, "w", zipfile.ZIP_DEFLATED) as zip_file:
            ...
            summary = self._generate_batch_summary(
                base_config, batch_size, markers_per_file
            )
    ...
    def generate_id_sequence_files(
        self, base_config: Dict[str, Any], id_ranges: List[Dict[str, int]]
    ) -> BytesIO:
    ...
    def _generate_batch_summary(
        self, config: Dict[str, Any], batch_size: int, markers_per_file: int
    ) -> str:
