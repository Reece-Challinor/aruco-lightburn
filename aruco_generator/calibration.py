...
class CalibrationPatternGenerator:
    ...
    def generate_charuco_board(self, 
        ...
        bordered_image = cv2.copyMakeBorder(board_image, 
                                           border_px, border_px, 
                                           border_px, border_px,
                                           cv2.BORDER_CONSTANT, 
                                           value=255)
        ...
        calibration_data = {
            ...
            "corner_positions": self._get_charuco_corners(squares_x, squares_y, square_size_mm),
    ...
    def generate_aruco_board(self,
                           ...
                           dictionary: str = "4X4_50",
                           first_marker_id: int = 0) -> Dict[str, Any]:
        """
        ...
        # Create GridBoard
        board = cv2.aruco.GridBoard((markers_x, markers_y),
                                   marker_size_mm,
                                   separation_mm,
                                   aruco_dict,
                                   marker_ids)
    ...
    def generate_apriltag(self,
                         tag_family: str = "tag36h11",
                         tag_id: int = 0,
                         tag_size_mm: float = 50.0,
                         border_bits: int = 1) -> Dict[str, Any]:
        """
        ...
        apriltag_dict = cv2.aruco.getPredefinedDictionary(self.apriltag_families[tag_family])
        ...
        # Add white border for printing
        border_px = int(10 * pixels_per_mm)
        bordered_image = cv2.copyMakeBorder(tag_image,
                                           border_px, border_px,
                                           border_px, border_px,
                                           cv2.BORDER_CONSTANT,
                                           value=255)
    ...
    def generate_apriltag_grid(self,
                              grid_x: int = 3,
                              grid_y: int = 3,
                              tag_family: str = "tag36h11",
                              tag_size_mm: float = 40.0,
                              spacing_mm: float = 20.0,
                              first_tag_id: int = 0) -> Dict[str, Any]:
        """
    ...
    def export_calibration_yaml(self, calibration_data: Dict[str, Any], filename: str = None) -> str:
        ...
        yaml_data = {
            ...
            "camera_matrix": {
                "rows": 3,
                "cols": 3,
                "data": [1000.0, 0.0, 960.0, 0.0, 1000.0, 540.0, 0.0, 0.0, 1.0]  # Default intrinsics
            },
    ...
    def export_ros_format(self, calibration_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        ros_data = {
            ...
            "pattern": {
                ...
                "physical_dimensions": {
                    "width": calibration_data.get("physical_width_mm", 0) / 1000.0,  # Convert to meters
        ...
        if "marker_corners_3d" in calibration_data:
            ...
            for i, corners in enumerate(calibration_data["marker_corners_3d"]):
                ros_data["pattern"]["markers"].append({
                    ...
                    "corners": [[c[0]/1000.0, c[1]/1000.0, c[2]/1000.0] for c in corners]
                })
        
        return ros_data
    
    def _get_charuco_corners(self, squares_x: int, squares_y: int, square_size: float) -> List[List[float]]:
